...
//신세계
public class Main2Activity extends AppCompatActivity implements   View.OnClickListener, MediaPlayer.OnCompletionListener {
    //Volley
    Button pick, upload1;
    ...
    public final static String VIDEO_URL = "http://35.243.90.95/zzal/1.mp4";
        ...
        voice_change_switch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) { //  활성화시 true, 비활성화시 false
                ...
                if(b){
                    ...
                    mFileName = "/" + login_member.member_id + "_1_"+is_change_voice+"_"+timeSet+".mp4";
...
//                });
        ...
        videoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                    ...
                    public void onPrepared(MediaPlayer mp) {
                        pd1.cancel();
                        Toast.makeText(Main2Activity.this, "동영상이 준비되었습니다. \n'시작' 버튼을 누르세요", Toast.LENGTH_SHORT).show();
                    }
                });
