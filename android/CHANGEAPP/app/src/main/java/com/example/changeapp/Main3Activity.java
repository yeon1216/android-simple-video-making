...
//신세계
public class Main3Activity extends AppCompatActivity implements   View.OnClickListener, MediaPlayer.OnCompletionListener {
    //Volley
    Button pick, upload1;
    ...
    public final static String VIDEO_URL = "http://35.243.90.95/zzal/2.mp4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voice_change_switch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) { //  활성화시 true, 비활성화시 false
                ...
                if(b){
                    ...
                    mFileName = "/" + login_member.member_id + "_2_"+is_change_voice+"_"+timeSet+".mp4";
     ...
     //   Toast.makeText(getApplicationContext(), "로그인 성공", Toast.LENGTH_SHORT).show();
      ...
      //  btnStop = (Button) findViewById(R.id.btnStop);
        ...
        pd2 = new ProgressDialog(Main3Activity.this);
...
//        progressBar.show();
        ...
        //미디어컨트롤러 추가하는 부분
        MediaController controller = new MediaController(Main3Activity.this);
...
//                });
        ...
        videoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                    ...
                    public void onPrepared(MediaPlayer mp) {
                        pd1.cancel();
                        Toast.makeText(Main3Activity.this, "동영상이 준비되었습니다. \n'시작' 버튼을 누르세요", Toast.LENGTH_SHORT).show();
                    }
                });
